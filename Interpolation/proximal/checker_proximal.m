function [score] = checker_proximal()
    ...
    score = PROXIMAL_points * (PROXIMAL_4point / PROXIMAL_4point_max / 5 + PROXIMAL_resize / PROXIMAL_resize_max / 5 + PROXIMAL_4point_RGB / PROXIMAL_4point_RGB_max / 5 + proximal_resize_RGB / proximal_resize_RGB_max / 5 + rotate / rotate_max / 10 + rotate_RGB / rotate_RGB_max / 10);
